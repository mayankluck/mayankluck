    ...
    public void onBindViewHolder(@NonNull @NotNull VoterviewAdapter holder, int position) {
            ...
            public void onClick(View v) {
                ...
                updatevoter.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference("VoterData").child(item.getFullname()+item.getAadhaarNo())
                                .updateChildren(map)
        ...
        holder.deleteVoter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.setMessage("Are You want to delete " + item.getFullname());
                dialog.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        FirebaseDatabase.getInstance().getReference().child("VoterData")
                                .child(item.getFullname()+""+item.getAadhaarNo()).removeValue();
